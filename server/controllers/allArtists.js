...
export const getOneArtist=async(req,res,next)=>{
    ...
    try {
      ...
      const data = await artist.findOne({ _id: new ObjectId(projectId) });
  ...
  export const updateArtist =async(req,res)=>{
    ...
    try {
      const result =  await artist.findByIdAndUpdate(filter,
        {
            name: req.body.name,
